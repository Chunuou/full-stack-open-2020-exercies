...
const OneAnecdote = ({ anecdote, vote }) => (
  <div>
...
const App = () => {
  ...
  const macth = useRouteMatch('/anecdotes/:id');
  ...
  const anecdote = macth ? anecdoteById(macth.params.id) : null;
    ...
    <div>
      ...
      <Switch>
        ...
        <Route path="/anecdotes/:id">
          <OneAnecdote anecdote={anecdote} vote={vote} />
        </Route>
        <Route path="/">
